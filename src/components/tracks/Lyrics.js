...
class Lyrics extends Component {
  ...
  render() {
    ...
    if (track===undefined||lyrics===undefined||Object.keys(track).length===0||Object.keys(lyrics).length===0) {return <Loader />}
    else {return (
      <div>
        ...
        <ul className="list-group mt-3">
          ...
          <li className="list-group-item">
            <strong>Updated Date</strong>: <Moment format="DD/MM/YYYY">{track.updated_time}</Moment>
          </li>
        </ul>
      </div>
     )}
